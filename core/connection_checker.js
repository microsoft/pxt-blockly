...
Blockly.ConnectionChecker.prototype.doSafetyChecks = function(a, b) {
  ...
  // pxt-blockly: Check removed to support nested shadow blocks
...
Blockly.ConnectionChecker.prototype.canConnectToPrevious_ = function(a, b) {
  ...
  var sourceBlock = a.getSourceBlock();
  ...
  // mid-stack.
  var sourceHasPreviousConn = sourceBlock.previousConnection != null;
