...
namespace pxtblockly {
    ...
    export class Extensions {
        ...
        /**
         * Extension to include the inline-svgs.
         */
        public static INLINE_SVGS() {
            (this as any).ADD_IMAGE_DATAURI =
            ...
            (this as any).REMOVE_IMAGE_DATAURI =
...
(Blockly as any).PXTBlockly.Extensions = pxtblockly.Extensions;

(Blockly as any).PXTBlockly.Extensions.registerAll();