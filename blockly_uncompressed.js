...
goog.addDependency("..\..\core\components\tree\basenode.js", ['Blockly.tree.BaseNode'], ['Blockly.Component', 'Blockly.utils.KeyCodes', 'Blockly.utils.aria', 'Blockly.utils.object', 'Blockly.utils.style']);
goog.addDependency("..\..\core\components\tree\treecontrol.js", ['Blockly.tree.TreeControl'], ['Blockly.tree.BaseNode', 'Blockly.tree.TreeNode', 'Blockly.utils.aria', 'Blockly.utils.object', 'Blockly.utils.style']);
goog.addDependency("..\..\core\components\tree\treenode.js", ['Blockly.tree.TreeNode'], ['Blockly.tree.BaseNode', 'Blockly.utils.KeyCodes', 'Blockly.utils.object']);
...
goog.addDependency("..\..\core\field_argumenteditor.js", ['Blockly.FieldArgumentEditor'], ['Blockly.Colours', 'Blockly.FieldTextInput', 'Blockly.Msg', 'Blockly.utils', 'goog.dom', 'goog.dom.TagName']);
...
goog.addDependency("..\..\core\field_colour_slider.js", ['Blockly.FieldColourSlider'], ['Blockly.DropDownDiv', 'Blockly.Field', 'Blockly.utils.colour', 'goog.dom', 'goog.events', 'goog.style', 'goog.ui.Slider']);
...
goog.addDependency("..\..\core\field_label_hover.js", ['Blockly.FieldLabelHover'], ['Blockly.FieldLabel']);
...
goog.addDependency("..\..\core\field_number.js", ['Blockly.FieldNumber'], ['Blockly.FieldTextInput', 'Blockly.Touch', 'Blockly.fieldRegistry', 'Blockly.utils.aria', 'Blockly.utils.object', 'Blockly.utils.userAgent']);
goog.addDependency("..\..\core\field_numberdropdown.js", ['Blockly.FieldNumberDropdown'], ['Blockly.FieldTextDropdown', 'Blockly.utils.userAgent']);
goog.addDependency("..\..\core\field_registry.js", ['Blockly.fieldRegistry'], []);
goog.addDependency("..\..\core\field_slider.js", ['Blockly.FieldSlider'], ['Blockly.FieldNumber', 'goog.dom', 'goog.events', 'goog.math', 'goog.style', 'goog.ui.Slider']);
goog.addDependency("..\..\core\field_string.js", ['Blockly.FieldString'], ['Blockly.FieldTextInput', 'Blockly.utils.userAgent', 'goog.dom', 'goog.events', 'goog.math', 'goog.style']);
goog.addDependency("..\..\core\field_textdropdown.js", ['Blockly.FieldTextDropdown'], ['Blockly.DropDownDiv', 'Blockly.FieldDropdown', 'Blockly.FieldTextInput', 'Blockly.utils.userAgent']);
goog.addDependency("..\..\core\field_textinput.js", ['Blockly.FieldTextInput'], ['Blockly.Colours', 'Blockly.Events', 'Blockly.Events.BlockChange', 'Blockly.Field', 'Blockly.Msg', 'Blockly.fieldRegistry', 'Blockly.pxtBlocklyUtils', 'Blockly.utils', 'Blockly.utils.Coordinate', 'Blockly.utils.KeyCodes', 'Blockly.utils.Size', 'Blockly.utils.aria', 'Blockly.utils.dom', 'Blockly.utils.object', 'Blockly.utils.userAgent']);
...
goog.addDependency("..\..\core\gesture.js", ['Blockly.Gesture'], ['Blockly.ASTNode', 'Blockly.BlockDragger', 'Blockly.BubbleDragger', 'Blockly.Events', 'Blockly.Events.Ui', 'Blockly.FlyoutDragger', 'Blockly.Tooltip', 'Blockly.Touch', 'Blockly.WorkspaceDragger', 'Blockly.blockAnimations', 'Blockly.constants', 'Blockly.navigation', 'Blockly.pxtBlocklyUtils', 'Blockly.utils', 'Blockly.utils.Coordinate']);
...
goog.addDependency("..\..\core\inject.js", ['Blockly.inject'], ['Blockly.BlockDragSurfaceSvg', 'Blockly.Component', 'Blockly.Css', 'Blockly.DropDownDiv', 'Blockly.Events', 'Blockly.Grid', 'Blockly.Msg', 'Blockly.Options', 'Blockly.ScrollbarPair', 'Blockly.Tooltip', 'Blockly.WorkspaceDragSurfaceSvg', 'Blockly.WorkspaceSvg', 'Blockly.constants', 'Blockly.user.keyMap', 'Blockly.utils', 'Blockly.utils.dom', 'Blockly.utils.userAgent']);
...
goog.addDependency("..\..\core\keyboard_nav\navigation.js", ['Blockly.navigation'], ['Blockly.ASTNode', 'Blockly.Action', 'Blockly.user.keyMap', 'Blockly.utils.Coordinate']);
goog.addDependency("..\..\core\keyboard_nav\tab_navigate_cursor.js", ['Blockly.TabNavigateCursor'], ['Blockly.ASTNode', 'Blockly.BasicCursor', 'Blockly.utils.object']);
...
goog.addDependency("..\..\core\names.js", ['Blockly.Names'], ['Blockly.Msg']);
goog.addDependency("..\..\core\options.js", ['Blockly.Options'], ['Blockly.Colours', 'Blockly.Theme', 'Blockly.Themes.Classic', 'Blockly.Xml', 'Blockly.user.keyMap', 'Blockly.utils.userAgent']);
...
goog.addDependency("..\..\core\pxt_blockly_events.js", ['Blockly.Events.EndBlockDrag'], ['Blockly.Events', 'Blockly.Events.BlockBase']);
goog.addDependency("..\..\core\pxt_blockly_functions.js", ['Blockly.Functions'], ['Blockly.Blocks', 'Blockly.Events.BlockChange', 'Blockly.Field', 'Blockly.Names', 'Blockly.Workspace', 'Blockly.constants']);
goog.addDependency("..\..\core\pxt_blockly_utils.js", ['Blockly.pxtBlocklyUtils'], []);
goog.addDependency("..\..\core\pxt_breakpoint.js", ['Blockly.Breakpoint'], ['Blockly.Events.BlockChange', 'Blockly.Events.Ui', 'Blockly.Icon', 'Blockly.utils.userAgent']);
goog.addDependency("..\..\core\pxt_utils.js", ['Blockly.PXTUtils'], ['goog.positioning.ClientPosition', 'goog.ui.CustomButton', 'goog.ui.Menu', 'goog.ui.MenuItem', 'goog.ui.Tooltip']);
...
goog.addDependency("..\..\core\renderers\measurables\types.js", ['Blockly.blockRendering.Types'], []);
...
goog.addDependency("..\..\core\renderers\thrasos\info.js", ['Blockly.thrasos', 'Blockly.thrasos.RenderInfo'], ['Blockly.blockRendering.BottomRow', 'Blockly.blockRendering.ExternalValueInput', 'Blockly.blockRendering.InlineInput', 'Blockly.blockRendering.InputRow', 'Blockly.blockRendering.Measurable', 'Blockly.blockRendering.NextConnection', 'Blockly.blockRendering.OutputConnection', 'Blockly.blockRendering.PreviousConnection', 'Blockly.blockRendering.RenderInfo', 'Blockly.blockRendering.Row', 'Blockly.blockRendering.SpacerRow', 'Blockly.blockRendering.StatementInput', 'Blockly.blockRendering.TopRow', 'Blockly.blockRendering.Types', 'Blockly.utils.object']);
goog.addDependency("..\..\core\renderers\thrasos\renderer.js", ['Blockly.thrasos.Renderer'], ['Blockly.blockRendering', 'Blockly.blockRendering.Renderer', 'Blockly.thrasos.RenderInfo', 'Blockly.utils.object']);
goog.addDependency("..\..\core\renderers\zelos\constants.js", ['Blockly.zelos.ConstantProvider'], ['Blockly.Colours', 'Blockly.blockRendering.ConstantProvider', 'Blockly.utils.dom', 'Blockly.utils.object', 'Blockly.utils.svgPaths']);
...
goog.addDependency("..\..\core\requires.js", ['Blockly.requires'], ['Blockly', 'Blockly.Comment', 'Blockly.FieldAngle', 'Blockly.FieldArgumentEditor', 'Blockly.FieldCheckbox', 'Blockly.FieldColour', 'Blockly.FieldDropdown', 'Blockly.FieldIconMenu', 'Blockly.FieldImage', 'Blockly.FieldLabelSerializable', 'Blockly.FieldMultilineInput', 'Blockly.FieldNumber', 'Blockly.FieldNumberDropdown', 'Blockly.FieldSlider', 'Blockly.FieldString', 'Blockly.FieldTextDropdown', 'Blockly.FieldTextInput', 'Blockly.FieldVariable', 'Blockly.FieldVerticalSeparator', 'Blockly.FlyoutButton', 'Blockly.Generator', 'Blockly.HorizontalFlyout', 'Blockly.Mutator', 'Blockly.Themes.Classic', 'Blockly.Themes.Dark', 'Blockly.Themes.Deuteranopia', 'Blockly.Themes.HighContrast', 'Blockly.Themes.Tritanopia', 'Blockly.Toolbox', 'Blockly.Trashcan', 'Blockly.VariablesDynamic', 'Blockly.VerticalFlyout', 'Blockly.Warning', 'Blockly.WorkspaceCommentSvg', 'Blockly.WorkspaceCommentSvg.render', 'Blockly.ZoomControls', 'Blockly.geras.Renderer', 'Blockly.thrasos.Renderer', 'Blockly.zelos.Renderer']);
...
goog.addDependency("..\..\core\theme_manager.js", ['Blockly.ThemeManager'], ['Blockly.Theme']);
goog.addDependency("..\..\core\theme.js", ['Blockly.Theme'], ['Blockly.utils', 'Blockly.utils.colour']);
goog.addDependency("..\..\core\theme\classic.js", ['Blockly.Themes.Classic'], ['Blockly.Colours', 'Blockly.Theme']);
goog.addDependency("..\..\core\theme\dark.js", ['Blockly.Themes.Dark'], ['Blockly.Css', 'Blockly.Theme']);
goog.addDependency("..\..\core\theme\deuteranopia.js", ['Blockly.Themes.Deuteranopia'], ['Blockly.Theme']);
goog.addDependency("..\..\core\theme\highcontrast.js", ['Blockly.Themes.HighContrast'], ['Blockly.Theme']);
goog.addDependency("..\..\core\theme\modern.js", ['Blockly.Themes.Modern'], ['Blockly.Theme']);
goog.addDependency("..\..\core\theme\tritanopia.js", ['Blockly.Themes.Tritanopia'], ['Blockly.Theme']);
goog.addDependency("..\..\core\theme\zelos.js", ['Blockly.Themes.Zelos'], ['Blockly.Theme']);
goog.addDependency("..\..\core\toolbox.js", ['Blockly.Toolbox'], ['Blockly.Css', 'Blockly.Events', 'Blockly.Events.Ui', 'Blockly.Touch', 'Blockly.navigation', 'Blockly.tree.TreeControl', 'Blockly.tree.TreeNode', 'Blockly.utils', 'Blockly.utils.Rect', 'Blockly.utils.aria', 'Blockly.utils.colour', 'Blockly.utils.dom', 'Blockly.utils.object']);
goog.addDependency("..\..\core\tooltip.js", ['Blockly.Tooltip'], ['Blockly.utils.string']);
goog.addDependency("..\..\core\touch_gesture.js", ['Blockly.TouchGesture'], ['Blockly.Gesture', 'Blockly.utils', 'Blockly.utils.Coordinate', 'Blockly.utils.object']);
goog.addDependency("..\..\core\touch.js", ['Blockly.Touch'], ['Blockly.utils', 'Blockly.utils.global', 'Blockly.utils.string']);
goog.addDependency("..\..\core\trashcan.js", ['Blockly.Trashcan'], ['Blockly.Scrollbar', 'Blockly.Xml', 'Blockly.utils.Rect', 'Blockly.utils.dom']);
...
goog.addDependency("..\..\core\workspace_comment_events.js", ['Blockly.Events.CommentBase', 'Blockly.Events.CommentChange', 'Blockly.Events.CommentCreate', 'Blockly.Events.CommentDelete', 'Blockly.Events.CommentMove'], ['Blockly.Events', 'Blockly.Events.Abstract', 'Blockly.utils.Coordinate', 'Blockly.utils.object', 'Blockly.utils.xml']);
...
goog.addDependency("..\..\core\workspace_svg.js", ['Blockly.WorkspaceSvg'], ['Blockly.BlockSvg', 'Blockly.Colours', 'Blockly.ConnectionDB', 'Blockly.DropDownDiv', 'Blockly.Events', 'Blockly.Events.BlockCreate', 'Blockly.Grid', 'Blockly.MarkerManager', 'Blockly.Msg', 'Blockly.Options', 'Blockly.ThemeManager', 'Blockly.Themes.Classic', 'Blockly.TouchGesture', 'Blockly.TouchGesture', 'Blockly.Workspace', 'Blockly.WorkspaceAudio', 'Blockly.WorkspaceDragSurfaceSvg', 'Blockly.Xml', 'Blockly.blockRendering', 'Blockly.constants', 'Blockly.navigation', 'Blockly.utils', 'Blockly.utils.Coordinate', 'Blockly.utils.Rect', 'Blockly.utils.dom', 'Blockly.utils.object']);
goog.addDependency("..\..\core\workspace.js", ['Blockly.Workspace'], ['Blockly.Events', 'Blockly.VariableMap', 'Blockly.utils', 'Blockly.utils.math']);
